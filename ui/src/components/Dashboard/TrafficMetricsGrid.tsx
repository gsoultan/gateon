    ...
    <SimpleGrid cols={{ base: 1, sm: 2, md: 3, lg: 5 }} spacing="md">
      {metrics.map((metric) => (
        <Paper 
          ...
          radius="md" 
          shadow="xs"
          style={{ transition: 'all 0.2s ease', borderTop: `3px solid var(--mantine-color-${metric.color}-6)` }} 
          ...
          <Group justify="space-between" mb="xs">
            ...
            {metric.diff !== undefined && (
              <Badge 
                ...
                variant="light" 
                size="sm"
                leftSection={metric.diff > 0 ? <IconArrowUpRight size="0.8rem" /> : <IconArrowDownRight size="0.8rem" />}
              >
