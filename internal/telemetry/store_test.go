...
func TestTraceDuplicateInsertion(t *testing.T) {
	...
	RecordTrace(traceID, "GET /test", "service-1", "service-1", 10.5, time.Now(), "success", "/test", "127.0.0.1", "", "US", "Go-http-client/1.1", "GET", "", "example.com/test", "", "", `{"User-Agent":"Go-http-client/1.1"}`, `{"Content-Type":"text/plain"}`, "", 100)
	RecordTrace(traceID, "GET /test", "service-1", "service-1", 10.5, time.Now(), "success", "/test", "127.0.0.1", "", "US", "Go-http-client/1.1", "GET", "", "example.com/test", "", "", `{"User-Agent":"Go-http-client/1.1"}`, `{"Content-Type":"text/plain"}`, "", 100)
